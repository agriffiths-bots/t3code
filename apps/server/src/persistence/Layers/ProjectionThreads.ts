    ...
    execute: (row) =>
      sql`
        ...
        DO UPDATE SET
          ...
          worktree_removable = excluded.worktree_removable,
          worktree_removal_path = excluded.worktree_removal_path,
    ...
    execute: ({ threadId }) =>
      sql`
        SELECT
          ...
          worktree_removable AS "worktreeRemovable",
          worktree_removal_path AS "worktreeRemovalPath",
