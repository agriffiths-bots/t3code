...
export interface ProjectionTurnRepositoryShape {
  ...
  /**
   * Appends a pending-start placeholder row for a thread.
   */
  ...
  /**
   * Deletes the oldest pending-start placeholder row (`turnId = null`) for a thread and leaves concrete turn rows untouched.
   */
