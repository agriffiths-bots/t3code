...
const ReactorLayerLive = Layer.empty.pipe(
  ...
  Layer.provideMerge(VcsMaintenanceReactor.layer),
  Layer.provideMerge(
...
const RuntimeDependenciesLive = Layer.mergeAll(PlanUsageSnapshot.layer, HeapDiagnostics.layer).pipe(
...
export const makeServerLayer = Layer.unwrap(
  Effect.gen(function* () {
    ...
    return serverApplicationLayer.pipe(
      Layer.provideMerge(ServerSelfUpdate.layer.pipe(Layer.provide(launcherLayer))),
