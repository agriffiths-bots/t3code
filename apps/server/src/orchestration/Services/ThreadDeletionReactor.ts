/**
 * ThreadDeletionReactor - Thread terminal-lifecycle cleanup reactor service interface.
 *
 * Owns background workers that react to terminal thread lifecycle events and
 * perform best-effort runtime cleanup for provider sessions, terminals, and
 * T3-created worktrees.
 *
...
/**
 * ThreadDeletionReactorShape - Service API for thread terminal cleanup.
 */
export interface ThreadDeletionReactorShape {
  /**
   * Start reacting to thread deletion, archive, and session-stop domain events.
   *
