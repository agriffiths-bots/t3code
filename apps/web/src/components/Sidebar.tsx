      ...
      <SidebarContent
        ...
        fixedHeader={
          ...
          <SidebarGroup className="relative z-[1] gap-1 p-[var(--sidebar-content-inset)]">
            ...
            <SidebarMenuButton
              type="button"
              className="relative ps-[calc(var(--sidebar-row-content-inset)-1px)] focus-visible:ring-offset-2 focus-visible:ring-offset-sidebar"
              onClick={handleScheduledClick}
            >
              <CalendarClockIcon className="size-4 shrink-0" />
              <span className="min-w-0 flex-1 truncate text-left">Scheduled</span>
              {enabledScheduleCount > 0 ? (
                <span className="inline-flex h-5 min-w-5 items-center justify-center rounded-lg px-1 text-xs tabular-nums">
