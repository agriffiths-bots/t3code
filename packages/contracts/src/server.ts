...
const PublicWebPushEndpoint = TrimmedNonEmptyString.check(
  Schema.makeFilter((endpoint: string) => getWebPushEndpointValidationError(endpoint) ?? true),
);

export const ServerWebPushSubscription = Schema.Struct({
  endpoint: PublicWebPushEndpoint,
