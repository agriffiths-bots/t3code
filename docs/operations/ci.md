...
- `.github/workflows/ci.yml` runs `vp check`, `vp run typecheck`, `vp run test`, desktop build verification, desktop launch smoke, and release smoke on pull requests and pushes to `main`.
